...
extension Device {
	...
	func info(for id: ObjectID) throws(MTPError) -> FileInfo {
	...
	func delete(_ id: ObjectID) throws(MTPError) {
	...
	@discardableResult
	func makeDirectory(named name: String, in parent: Folder, storage: StorageID) throws(MTPError) -> FileInfo {
	...
	func move(_ id: ObjectID, to parent: Folder, storage: StorageID) throws(MTPError) {
	...
	@discardableResult
	func makeDirectory(named name: String, in parent: Folder, storage: StorageInfo) throws(MTPError) -> FileInfo
	{
		try makeDirectory(named: name, in: parent, storage: storage.id)
	}

	func move(_ id: ObjectID, to parent: Folder, storage: StorageInfo) throws(MTPError) {
	...
	func info(for file: some FileReference) throws(MTPError) -> FileInfo {
		try info(for: file.objectID)
	}

	func delete(_ file: some FileReference) throws(MTPError) {
		try delete(file.objectID)
	}

	@discardableResult
	func rename(_ file: some FileReference, to newName: String) throws(MTPError) -> FileInfo {
		try rename(file.objectID, to: newName)
	}

	func move(_ file: some FileReference, to parent: Folder, storage: StorageID) throws(MTPError) {
		try move(file.objectID, to: parent, storage: storage)
	}

	func move(_ file: some FileReference, to parent: Folder, storage: StorageInfo) throws(MTPError) {
		try move(file.objectID, to: parent, storage: storage)
	}

	@discardableResult
	func rename(_ id: ObjectID, to newName: String) throws(MTPError) -> FileInfo {
